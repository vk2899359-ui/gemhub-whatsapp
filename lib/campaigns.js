...
// objects/arrays on read (not just numeric-looking strings — the same class
// of surprise, different shape). Handle both: already-an-object needs no
// parsing; a string does.
