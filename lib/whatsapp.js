...
function describeInbound(message) {
  ...
  if (type === 'image') return { kind: 'image', caption: message.image?.caption || '' };
  if (type === 'video') return { kind: 'video', caption: message.video?.caption || '' };
  if (type === 'audio') return { kind: 'audio' };
  if (type === 'document') {
    return { kind: 'document', caption: message.document?.caption || '', filename: message.document?.filename || '' };
  }
  if (type === 'sticker') return { kind: 'sticker' };
